        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Creating and configuring tables, schemas, views. Experience with
                OLAP cubes, window functions. Complex scripts and procedures.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                ...
                decorators, parallel threads, generators. Experience with NumPy,
                Pandas, Matplotlib.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Forecasting, statistical data collection and analysis, selection
                of driver indicators, business resource study, budget
                preparation.
              </p>
            </div>
