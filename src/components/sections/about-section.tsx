...
export function AboutSection() {
  ...
  const aboutCards = aboutData.cards.map((card, index) => (
    <Card
      ...
      className={`overflow-y-auto max-h-[calc(100vh-21rem)] first:text-base first:xs:text-lg first:sm:text-2xl ${
  ...
  return (
    ...
    >
      <div className="flex flex-row flex-wrap gap-2 lg:gap-4 xl:gap-8 mb-24 lg:mb-4">
        {aboutCards}
      </div>
    </Section>
  );
